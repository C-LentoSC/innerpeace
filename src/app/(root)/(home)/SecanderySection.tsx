  ...
  return (
    ...
    >
      ...
      <header className="w-full max-w-[280px] sm:max-w-[320px] md:max-w-[380px] lg:max-w-[454px] px-3 sm:px-4 md:px-6">
        <h3
          className="text-center text-amber-200 text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 
      ...
      {/* Image Container */}
      <div
        className="w-full max-w-[240px] sm:max-w-[320px] md:max-w-[400px] lg:max-w-[500px] xl:max-w-[566px] 
      ...
      >
        ...
        <div className="absolute bottom-2 sm:bottom-3 md:bottom-4 lg:bottom-6 xl:bottom-8 right-2 sm:right-3 md:right-4 lg:right-6 xl:right-8">
          <div
            className="w-[200px] xs:w-[220px] sm:w-[260px] md:w-[280px] lg:w-[320px] xl:w-[340px] 
          ...
          >
            {/* Description */}
            <div
              className="text-center text-zinc-300 text-[10px] xs:text-xs sm:text-sm font-medium 
...
const SecondarySection = () => {
  ...
  const setupAnimations = useCallback(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const cardElements =
        sectionRef.current?.querySelectorAll("[data-card-index]");
  ...
  return (
    ...
    >
      <div className="my-container py-12 sm:py-16 md:py-20">
        {/* Section Header */}
        <header ref={titleRef} className="text-center mb-8 sm:mb-12 md:mb-16">
          <h2
